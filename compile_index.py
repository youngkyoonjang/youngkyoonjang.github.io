      ...
      <header class="profile-header">
        ...
        <div class="profile-info-area">
          ...
          <p class="bio-paragraph">
            I am a staff ML engineer in the Autonomy & AI team at <a href="https://rivian.com/" target="_blank">Rivian</a> in London, where I work on perception for 3D vision and closed-loop simulation. I received my Ph.D. from <a href="http://www.kaist.ac.kr/html/en/" target="_blank">KAIST</a> in 2015, supervised by <a href="https://scholar.google.com/citations?user=s3Z4Q1oAAAAJ&hl=en" target="_blank">Woontack Woo</a> and co-advised by <a href="https://sites.google.com/view/tkkim/" target="_blank">Tae-Kyun Kim</a> at <a href="https://www.imperial.ac.uk/" target="_blank">Imperial College London</a>.
          </p>
          <p class="bio-paragraph">
            My research explores novel visual sensing technologies aimed at making interactions between humans and autonomous systems more intuitive in real-world environments. My expertise spans tough technical challenges in computer vision and machine learning, with a focus on 3D vision (CVPR, ICCV, IJCV, CVIU), pattern recognition (PRL), AR/VR (ISMAR, IEEE VR, TVCG), and human-machine interaction (ICRA, THMS, 3DUI, HCII).
          </p>
...
if OBFUSCATE_EMPLOYER:
    ...
    header_tmpl = header_tmpl.replace(
        'I am a staff ML engineer in the Autonomy & AI team at <a href="https://rivian.com/" target="_blank">Rivian</a> in London',
        'I am a staff ML engineer in the XXX team at YYY in London'
    )
