...
def parse_news():
    news = [
        {"date": "2026.06.18", "desc": "Paper accepted to ECCV 2026 as an Oral presentation, Malmö, Sweden. [<a href=\"https://saresgs.github.io\" target=\"_blank\" rel=\"nofollow\">Project</a>] [<a href=\"http://arxiv.org/abs/2601.03024\" target=\"_blank\" rel=\"nofollow\">arXiv</a>]"},
      ...
      <header class="profile-header">
        ...
        <div class="profile-info-area">
          ...
          <div class="social-links-row" style="margin-top: 24px;">
            ...
            <a href="https://www.linkedin.com/in/youngkyoon-jang-5110ab12/" target="_blank">
...
html_out.append("""              </div>
    ...
    <div id="feedback-card" class="feedback-card">
      ...
      <div class="feedback-body">
        <p class="feedback-desc">Feel free to share your thoughts, questions, or suggestions about my work, research, or anything else!</p>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', () => {
        ...
        const googleSheetCSVUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRIVe8s946tf55ZVYd7izwfAA_9nhf8TjO2OjJE1t1RLTXXIzT7TdcMZ0ujzzvw3TNq4k67aSz956tc/pub?gid=1022689768&single=true&output=csv';
        let googleComments = [];
        ...
        form.addEventListener('submit', (e) => {
          ...
          formData.append('entry.353575263', name);
          formData.append('entry.557142731', text);

          fetch('https://docs.google.com/forms/d/e/1FAIpQLSeGE_ocIg76OBIB1ukXmihOMLXmgTAkOfZj5zEMZExXZojl3w/formResponse', {
            method: 'POST',
            mode: 'no-cors',
            body: formData
          })
          .then(() => {
            ...
            // Close card after a short delay
            setTimeout(() => {
              card.classList.remove('show');
            }, 1000);
          })
